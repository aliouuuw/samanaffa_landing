...
export const NewContactForm: React.FC<NewContactFormProps> = ({
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    savingMotivation: selectedObjective || '',
    idealMonthlyAmount: '',
    selectedObjective,
    monthlyAmount,
    duration,
  ...
  useEffect(() => {
    setFormData(prev => ({
      ...
      duration,
      projectedAmount,
      savingMotivation: selectedObjective || prev.savingMotivation
    }));
  }, [selectedObjective, monthlyAmount, duration, projectedAmount]);
  ...
  const handleMotivationSelect = (motivationTitle: string) => {
    handleInputChange('savingMotivation', motivationTitle);
              ...
              <div className="relative">
                ...
                >
                  <span className={formData.savingMotivation ? 'text-gray-900' : 'text-gray-400'}>
                    {formData.savingMotivation || 'Sélectionnez une motivation'}
                  </span>
