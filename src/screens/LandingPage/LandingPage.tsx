...
const personas = [
  ...
  },
  {
    ...
    quote:
      "Tu veux réussir sans être freinée par l'argent. C'est possible, même avec un petit budget.",
  },
  {
    id: "chauffeur",
    ...
    quote:
      "Tu bosses dur tous les jours. Une bonne épargne peut t'offrir un vrai bol d'air.",
  },
  {
    id: "commercante",
    ...
    quote:
      "Tu gagnes de l'argent chaque jour, mais tu veux mieux le garder pour avancer.",
  },
  {
    id: "entrepreneur",
    ...
    quote:
      "Tu veux transformer tes idées en business solide. L'épargne, c'est ton levier.",
  },
  {
    id: "diaspora",
    ...
    quote:
      "Tu veux soutenir le pays, mais aussi poser les bases de ton propre projet.",
  },
  {
    id: "mere",
  ...
  },
  {
    ...
    quote:
      "Après une vie de service, tu veux une retraite paisible et bien préparée.",
  },
  {
    id: "journalier",
  ...
  },
  {
    ...
    quote:
      "Tu vends en ligne, tu avances vite. Épargne un peu chaque gain, et regarde ton projet grandir.",
  },
  {
    id: "talibe",
  ...
  },
  {
    ...
    quote:
      "Tu es un pilier pour ta communauté. Planifie et montre l'exemple par l'épargne.",
  },
];
  ...
  return (
    <div className="bg-white flex flex-row justify-center w-full">
      <div className="bg-white w-full max-w-[1440px] relative">
        {/* Hero Section - Responsive with flexbox layout */}
        <section className="relative w-full min-h-screen overflow-hidden">
          ...
          <div className="relative w-full h-full z-10">
            ...
            <div className="flex flex-col md:grid md:grid-cols-3 md:gap-8 lg:gap-12 xl:gap-16 min-h-screen px-4 sm:px-6 lg:px-8 xl:px-16 pt-20 md:pt-24 lg:pt-32">
              <div>
              </div>
              ...
              <div className="flex-shrink-0 flex flex-col items-center justify-center md:justify-end md:pb-0 md:col-span-1 pb-24 space-y-6 md:space-y-8 lg:space-y-12">
                ...
                <div className="flex justify-center">
                  <img
                    className="w-[280px] sm:w-[320px] md:w-[350px] lg:w-[400px] xl:w-[450px] h-auto hover:scale-105 transition-transform duration-500 drop-shadow-2xl z-20"
          ...
          <div className="flex justify-center mb-12 lg:mb-16">
            <div className="grid grid-cols-2 lg:flex gap-4 lg:gap-8 max-w-4xl">
              {objectives.map((objective, index) => (
                ...
                >
                  <div
                    className={`w-[120px] h-[120px] lg:w-[162px] lg:h-[162px] rounded-full relative mb-3 lg:mb-4 transition-all duration-500 group-hover:shadow-lg group-hover:-translate-y-2 ${
                      selectedObjective === objective.id
                  ...
                  <span
                    className={`font-medium text-lg lg:text-[26px] transition-all duration-300 text-center mb-1 lg:mb-2 ${
                      selectedObjective === objective.id
